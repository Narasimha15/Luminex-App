...
export const appwriteConfig = {
  ...
  projectId: "6730d78c002e0650e266",
  databaseId: "6730ddd6000bcbbe95b4",
  userCollectionId: "6730e760002604e680db",
  videoCollectionId: "6730e7d7003c009ead6d",
  storageId: "6730eb630030d97d59b5",
};
...
export async function createUser(email, password, username) {
  try {
    ...
    // Sign in user automatically after creating account
...
export async function searchPosts(query) {
  try {
    ...
    if (!posts) throw new Error("No posts found for the query");
